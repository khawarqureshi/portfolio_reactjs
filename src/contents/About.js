...
const About = () => {
  return (
    <div className="condiv">
      ...
      <h4>Hey there,</h4>
      <h1>I'm M. Khawar Qureshi</h1>
      <h3>
        Front End <u>Developer</u> | UI/UX <u>Designer</u>
      </h3>
      <br></br>
      <p>
        I started my journey in the world of computers from an young age, now
        I’m 20 years old, Pursuing my Software Engineering Degree in Bahria
        University Islamabad. Web development is my center of interest, i always
